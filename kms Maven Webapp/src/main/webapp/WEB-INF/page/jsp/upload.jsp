...
<head>
	...
	<jsp:include page="/WEB-INF/page/jsp/common.jsp"></jsp:include>
	    ...
	    function formBn(value){
	    	return '<a href="${pageContext.request.contextPath}/file/downloadFile.do?id='+value+'" class="easyui-linkbutton" iconCls="icon-add" plain="true">下载</a>'
	    }
	</script>
...
<body>
	...
	<table id="fileDg" title="" class="easyui-datagrid" fit="true"
		...
		<thead>
			<tr>
				<th checkbox="true" field="" width="30" sortable="true"></th>
				<th field="name" width="60" sortable="true">文件名</th>
				<th field="user" width="60" sortable="true">用户</th>
				<th field="comments" width="60" sortable="true">备注</th>
				...
				<th field="flag" width="40" sortable="true">标识</th>
				 -->
				<th formatter="formBn" field="id" width="30" sortable="true">操作</th>
			</tr>
		</thead>
	</table>
